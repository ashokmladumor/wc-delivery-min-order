	...
	public function woocommerce_admin_fields( $options ) {
  	...
  	public function get_delivery_tab_settings_fields() {
  		...
  		if ($current_section == 'min-order-amount') {
			...
			echo '<script type="text/template" id="template-add-fee-field">
				<tr>
					<td>
						<input name="{{miles_from_name}}" type="number" value="" class="mile-field from-range" placeholder="'.__("Miles", "").'" />
						<span> - </span>
						<input name="{{miles_to_name}}" type="number" value="" class="mile-field to-range" placeholder="'.__("Miles", "").'" />
					</td>
					<td>
						<input name="{{fee_name}}" type="number" value="" class="mile-field" placeholder="'.__("Fee", "").'" />
					</td>
					<td>
